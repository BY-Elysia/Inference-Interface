...
class CDDataAugmentation:
    ...
    def transform(self, image, mask, to_tensor=True):
        ...
        # transforming to PIL image-PIL 转换
        ...
        #     affine_params = T.RandomAffine(degrees=0, shear=(5, 30)).get_params(
        #         degrees=(0, 0), translate=None, scale_ranges=None, shears=(5, 30), img_size=image.size
        #     )
